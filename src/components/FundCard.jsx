...
const FundCard = ({
    owner,title,description,target,deadline,amountCollected,image,handleClick,category
}) => 
{
  ...
  return (
    <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer  ' onClick={handleClick}>
        ...
        <div className='block'>
            ...
            <p className='font-normal mt-[5px]  text-[#808191] text-left leading-4 truncate '>{description}</p>
            </div>

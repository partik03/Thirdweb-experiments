      ...
      <div className='mt-[60px] flex lg:flex-row flex-col gap-5 ' >
        <div className='flex-[2] flex flex-col gap-[40px]  '>
          ...
          <div className=''>
            ...
            <div className='mt-[20px] flex flex-row items-center flex-wrap gap-[1rem]   '>
                <div className='w-[52px] h-[52px] flex items-center justify-center rounded-full bg-[#2c2f32] cursor-pointer '>
                    <img src={thirdweb} alt="user" className='w-[60%] h-[60%] object-contain ' />
                </div>
                <div className='  '>
                    <h4 className='font-semibold text-[1rem] text-white break-all  '>
                      {state.owner}
                    </h4>
            ...
            donators.map((e,i)=>{
                return(
                    <div key={i} className="flex justify-between items-center gap-4 ">
                      <p className='font-normal text-[16px] text-[#b2b3bd] leading-[26px] break-11 '>{i+1}. {e.donator}</p>
                      <p className='font-normal text-[16px] text-[#808191] leading-[26px] break-11 '>{e.donation}</p>
                    </div>
                )
            })
          :
          ...
          <div className='flex-1 '>
              ...
              <div className='mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px] '>
                ...
                <div className='mt-[30px]'>
                    <input type="number" placeholder='ETH 0.1' 
                    step={0.1} 
                    ...
                    <div className="my-[20px] p-4 bg-[#13131a] rounded-[10px]   ">
                        <h4 className='font-semibold text-[1rem] leading-[22px] text-white  '>Back it because you believe in it.</h4>
                        <p className='mt-[20px] font-normal leading-[22px] text-[#808191] '>Support the project for no rewar, just because it speaks to you.</p>
                    </div>
